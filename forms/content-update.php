...
<div class="d4p-content">
    <div class="d4p-update-info">
        ...
        <div class="d4p-install-block">
            <h4>
				<?php _e( "Cache Cleanup", "coreseo" ); ?>
            </h4>
            <div>
				<?php _e( "Cleanup completed.", "coreseo" ); ?>
            </div>
        </div>
        ...
        <div class="d4p-install-block">
            ...
            <div>
				<?php _e( "Update completed.", "coreseo" ); ?>
            </div>
        </div>

        <div class="d4p-install-confirm">
            <a class="button-primary" href="<?php echo panel()->a()->panel_url( 'about' ) ?>&update"><?php _e( "Click here to continue", "coreseo" ); ?></a>
        </div>
    </div>
